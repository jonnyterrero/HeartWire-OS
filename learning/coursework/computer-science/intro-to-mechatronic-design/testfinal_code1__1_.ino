...
if (cmd == 'G') {
  ...
  moveHandToAngle(manualHandAngle);
    ...
    if (cmd == 'G') {
      adjustServoAngle(currentPose.hand, SERVO_STEP, HAND_MIN_SAFE, HAND_MAX_SAFE);
      hand.write(currentPose.hand);
      Serial.print(F("Manual hand angle: "));
      Serial.println(currentPose.hand);
    }
