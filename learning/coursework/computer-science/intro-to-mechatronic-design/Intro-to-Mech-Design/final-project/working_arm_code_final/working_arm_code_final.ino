...
int SCAN_WRIST     = 55; //was 65

 

int PICKUP_FOREARM = 45;

int PICKUP_WRIST   = 98; //95 before
...
void loop() {
  ...
  switch (currentState) {
    ...
    case STATE_DETECT: {
      ...
      moveServoSmooth(hand, posHand, CLAW_OPEN);
    ...
    case STATE_GRAB: {
      ...
      moveServoSmooth(hand, posHand, CLAW_CLOSED);
